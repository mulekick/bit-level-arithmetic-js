...
const
    // ====================================================
    // Declarations
    {chalk, table, DataViewAugmented, le, NUMBER_8_BITS, NUMBER_16_BITS, NUMBER_32_BITS, toFixedPoint, toRational, addInteger, subtractInteger, multiplyInteger, longDivideRational, dec2base, asciitbl, deepcopy, output, add, sub, mul, div} = require(`./lib.js`),
